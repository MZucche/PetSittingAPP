...
const Prueba = () => {
    ...
    const [availabilityFrequency, setAvailabilityFrequency] = useState('');
    ...
    async function handleSubmit(e){
      ...
      try {
        ...
        if (response.ok){
          console.log("Se realizo correctamente la publicacion");
        }else{
          console.error("Error al crear la publicación:", await response.json());
        }
